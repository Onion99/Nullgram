...
package org.telegram.ktx.systemservices
...
inline val autofillManager: AutofillManager
    @RequiresApi(26) get() = ApplicationLoader.applicationContext.getSystemService(AutofillManager::class.java)
...
inline val sliceManager: SliceManager
    @RequiresApi(28) get() = ApplicationLoader.applicationContext.getSystemService(SliceManager::class.java)
...
inline val contentCaptureManager: ContentCaptureManager
    @RequiresApi(29) get() = ApplicationLoader.applicationContext.getSystemService(ContentCaptureManager::class.java)

@Suppress("UNCHECKED_CAST")
@PublishedApi
internal fun <T> getSystemService(name: String) = ApplicationLoader.applicationContext.getSystemService(name) as T
